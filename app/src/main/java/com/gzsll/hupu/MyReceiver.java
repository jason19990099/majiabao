...
//        if (MainWebviewActivity.isForeground) {
//            String message = bundle.getString(JPushInterface.EXTRA_MESSAGE);
//            String extras = bundle.getString(JPushInterface.EXTRA_EXTRA);
//            Intent msgIntent = new Intent(MainWebviewActivity.MESSAGE_RECEIVED_ACTION);
//            msgIntent.putExtra(MainWebviewActivity.KEY_MESSAGE, message);
